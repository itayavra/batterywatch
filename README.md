...
| **HeadsetControl** | Gaming headsets via the [HeadsetControl](https://github.com/Sapd/HeadsetControl) CLI tool — SteelSeries Arctis series, HyperX Cloud models, Corsair VOID, ROCCAT Elo, Audeze Maxwell, Sony INZONE, and others (requires `headsetcontrol` to be installed separately) |
