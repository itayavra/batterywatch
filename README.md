...
| **HeadsetControl** | Gaming headsets via the [HeadsetControl](https://github.com/Sapd/HeadsetControl) CLI tool — SteelSeries Arctis series, HyperX Cloud models, Corsair VOID, ROCCAT Elo, Audeze Maxwell, Sony INZONE, and others; Logitech headsets are skipped (handled by the HID provider) (requires `headsetcontrol` to be installed separately) |
